var $children, $wrapper, _, callback, chai, children, doc, fs, html, jsdom, multipleClassNames, nodeToAppend, pathToSolution, prepareDOM, should, singleClassName, sinon, sinonChai, tagName, text, wrapper;
